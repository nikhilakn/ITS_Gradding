...
class getGrade:
    def gradeIcorrect(self,fp1,fp2,t):
        try:
            ...
            regr_rf=pickle.load(open("q5_gm.sav", 'rb'))#load pre-trained grading model for question1
...
fp1="../../../Exp/DataSet/APR_Data_set/Python/data/question_5/code/Incorrect/wrong_5_008.py" #incorrect solution
fp2="../../../Exp/DataSet/APR_Data_set/Python/data/question_5/code/Correct/correct_5_001.py" #reference solution
t=3
